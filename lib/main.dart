...
import 'package:location_pour_etudiants/screen/accueilproprietaire.dart';
import 'package:location_pour_etudiants/screen/add_foyer_priv%C3%A9.dart';
...
/*void main() async {
  ...
  //await FirebaseAuth.instance.useAuthEmulator('localhost', 55068);
  runApp(MyApp());
}
